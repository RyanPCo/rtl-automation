...
set_property -dict { PACKAGE_PIN H12   IOSTANDARD LVCMOS33 } [get_ports { FPGA_SERIAL_TX }]; # set_property PACKAGE_PIN H12 [get_ports {JA_tri_io[1]}]
set_property -dict { PACKAGE_PIN H11   IOSTANDARD LVCMOS33 } [get_ports { FPGA_SERIAL_RX }]; # set_property PACKAGE_PIN H11 [get_ports {JA_tri_io[2]}]
